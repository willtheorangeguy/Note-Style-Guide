...
!(function (e) {
  ...
  function n(e, t, n, o) {
    if ("opening" === t || "open" === t)
      var a = n || "au-accordion--closed",
        i = o || "au-accordion--open";
    else
      var a = o || "au-accordion--open",
        i = n || "au-accordion--closed";
    !(function (e, t) {
      e.classList
  ...
  var o = {};
  (o.Toggle = function (o, a, i) {
    try {
      (window.event.cancelBubble = !0), event.stopPropagation();
    } catch (e) {}
    void 0 === o.length && (o = [o]), "object" != typeof i && (i = {});
    for (var l = 0; l < o.length; l++) {
      var c = o[l],
        r = c.getAttribute("aria-controls"),
          ...
          e.animate.Toggle({
            ...
            postfunction: function (e, t) {
              "closed" === t
                ...
                : ((e.style.display = ""),
                  (e.style.height = ""),
                  "function" == typeof i.afterOpen && i.afterOpen()),
                n(e, t);
            },
          });
        })(c);
    ...
    (o.Open = function (o, a) {
      ...
      for (var i = 0; i < o.length; i++) {
        var l = o[i],
          c = l.getAttribute("aria-controls"),
          r = document.getElementById(c),
          s = 0;
        (s =
          "undefined" != typeof getComputedStyle
            ? window.getComputedStyle(r).height
            : r.currentStyle.height),
          0 === parseInt(s) && (r.style.height = "0px"),
          (r.style.display = ""),
          n(r, "opening"),
          n(l, "opening"),
          t(l, 0, "opening"),
...
!(function (e) {
  function t(e, t, n) {
    ...
    return (
      (i = n / r),
      Math.abs(i) < 1e3 / 60 &&
        ((i = 1e3 / 60), (a = o / (r = Math.ceil(Math.abs(n / i))))),
      { stepSize: a, steps: r - 1, intervalTime: i }
    );
  }
  var n = {};
  "undefined" != typeof module && (n.CalculateAnimationSpecs = t),
    (n.GetCSSPropertyBecauseIE = function (t, n) {
    ...
    (n.Run = function (n) {
      var o = n.element,
        i = n.speed || 250;
      void 0 === o.length && (o = [o]),
        "function" != typeof n.callback && (n.callback = function () {}),
        (o[0].AUinteration = 0),
        (o[0].AUinterations = o.length);
      for (var a = 0; a < o.length; a++) {
        var r = o[a];
        e.animate.Stop(r);
        var l = parseInt(e.animate.GetCSSPropertyBecauseIE(r, n.property)),
          p = n.endSize;
        "auto" === n.endSize && (p = e.animate.CalculateAuto(r, n.property));
        var u = t(l, p, i),
          c = l;
        u.stepSize < 0
          ? (r.AUtoggleState = "closing")
          : u.stepSize > 0 && (r.AUtoggleState = "opening"),
          (function (t, i, a, r, l) {
            t.AUanimation = setInterval(function () {
              if (i === l || 0 === r.steps) {
                if (
                  (e.animate.Stop(t),
                  (t.style[n.property] = l + "px"),
                  (t.AUtoggleState = ""),
                  o[0].AUinteration++,
                  "auto" === n.endSize && (t.style[n.property] = ""),
    ...
    (n.Toggle = function (t) {
      var n = t.element,
        o = t.property || "height",
        i = t.speed || 250,
        a = void 0 === t.closeSize ? 0 : t.closeSize,
        r = void 0 === t.openSize ? "auto" : t.openSize;
      void 0 === n.length && (n = [n]),
        "function" != typeof t.prefunction && (t.prefunction = function () {}),
        "function" != typeof t.postfunction &&
          (t.postfunction = function () {}),
      ...
      for (var l = 0; l < n.length; l++) {
        ...
        var u,
          c = "",
          s = "",
          f = parseInt(e.animate.GetCSSPropertyBecauseIE(p, t.property));
        if (f === a || "closing" === p.AUtoggleState)
          (u = r), (c = "opening"), (s = "open");
        else {
        ...
        t.prefunction(p, c),
          e.animate.Run({
            ...
            callback: function () {
              if (
                (n[0].AUtoggleInteration++,
                n[0].AUtoggleInteration === n[0].AUinterations)
              ) {
                var e = t.callback(p, s);
                return t.postfunction(p, s), e;
              }
              t.postfunction(p, s);
            },
          });
...
!(function (e) {
  function n(e, n, t, o) {
    if ("opening" === n || "open" === n)
      var a = t || "au-main-nav__content--closed",
        l = o || "au-main-nav__content--open";
    else
      var a = o || "au-main-nav__content--open",
        l = t || "au-main-nav__content--closed";
    !(function (e, n) {
      e.classList
  ...
  function t(e, n, t) {
    function o(e) {
      ...
      return !1 === n && (e.stopPropagation(), e.preventDefault()), n;
    }
    function a() {
    ...
    return e.addEventListener
      ? (e.addEventListener(n, o, !1), { element: e, handler: o, event: n })
      : (e.attachEvent("on" + n, a), { element: e, handler: a, event: n });
  }
  function o(e) {
  ...
  (a.Toggle = function (i, u, s) {
    if (!c) {
      ...
      var r = i.getAttribute("aria-controls"),
        ...
        p = f.querySelector(".au-main-nav__menu"),
        d = f.querySelector(".au-main-nav__overlay"),
        v = f.querySelector(".au-main-nav__toggle--close"),
        y = f.querySelector(".au-main-nav__toggle--open"),
        m = f.querySelector(".au-main-nav__focus-trap-top"),
        _ = f.querySelector(".au-main-nav__focus-trap-bottom"),
        g = p.querySelectorAll("a, .au-main-nav__toggle"),
        b = -1 === f.className.indexOf("au-main-nav__content--open"),
        S = p.offsetWidth,
        w = b ? "opening" : "";
            ...
            prefunction: function () {
              "opening" === w
                ? ((p.style.display = "block"),
                  (d.style.left = 0),
                  (d.style.opacity = 0.5),
                  "function" == typeof s.onOpen && s.onOpen())
                : ((d.style.opacity = "0"),
            ...
            postfunction: function () {
              "opening" === w
                ? (v.focus(),
                  ...
                  (l.focusTop = t(m, "focus", function () {
                    g[g.length - 1].focus();
                  })),
                  (l.focusBottom = t(_, "focus", function () {
                    g[0].focus();
                  })),
                  (l.escKey = t(document, "keyup", function () {
                    ...
                    27 === e.keyCode && "block" === n && a.Toggle(i, r, s);
                  })),
                  "function" == typeof s.afterOpen && s.afterOpen())
                : (y.focus(),
                  ...
                  o(l.focusBottom),
                  o(l.escKey),
                  "function" == typeof s.afterClose && s.afterClose()),
                n(u, w),
                n(
                  document.body,
                  w,
