# Note Style Guide Privacy Policy
...
- **Application** means the software program provided by the Company downloaded by You on any electronic device, named the Note Style Guide.
